...
public:
  ...
  nao_lola_sensor_msgs::msg::Buttons getButtons();
  nao_lola_sensor_msgs::msg::FSR getFSR();
  nao_lola_sensor_msgs::msg::Gyroscope getGyroscope();
  nao_lola_sensor_msgs::msg::JointCurrents getJointCurrents();
  nao_lola_sensor_msgs::msg::JointPositions getJointPositions();
  nao_lola_sensor_msgs::msg::JointStiffnesses getJointStiffnesses();
  nao_lola_sensor_msgs::msg::JointTemperatures getJointTemperatures();
  nao_lola_sensor_msgs::msg::JointStatuses getJointStatuses();
  nao_lola_sensor_msgs::msg::Sonar getSonar();
  nao_lola_sensor_msgs::msg::Touch getTouch();
  nao_lola_sensor_msgs::msg::Battery getBattery();
  nao_lola_sensor_msgs::msg::RobotConfig getRobotConfig();
