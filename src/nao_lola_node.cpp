...
#include "nao_lola/nao_lola_node.hpp"
...
NaoLolaNode::NaoLolaNode(const rclcpp::NodeOptions & options)
: rclcpp::Node{"NaoLolaNode", options}, impl(std::make_shared<NaoLolaNode::Impl>())
{
...
void NaoLolaNode::Impl::createPublishers()
{
...
void NaoLolaNode::Impl::createSubscriptions()
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(NaoLolaNode)
